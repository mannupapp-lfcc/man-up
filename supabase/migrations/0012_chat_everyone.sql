-- Explicit @everyone mention for ministry leaders (including co-leaders/admins).
-- Only explicit @everyone posts fan out: one queued alert per eligible recipient,
-- excluding the sender, departed members, and anyone who blocked the sender.
-- No push delivery is implemented here. Existing function grants are preserved.
